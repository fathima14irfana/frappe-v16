# frappe-v16
This Repo is for Codespace spinup for Frappe v16 demo. Contains apps Frappe, ERPNext, Insights and Raven.

## 🛠️ How to Spin Up a Demo Instance (Codespaces)

Follow these steps to run ERPNext + Frappe V16 in a GitHub Codespace:

1. **Open Codespace**
   - Open a Codespace for this repository (use the **main** branch).
   ![Codespace](./docs/codespace-image.png)
